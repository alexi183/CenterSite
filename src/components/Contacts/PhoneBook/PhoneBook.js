...
class PhoneBook extends Component {
    ...
    notFound = () => {
        ...
        return Object.keys(initQuery).length > 0 && this.props.contactsStore.staff.length < 1
    }
    ...
    submitQuery = e => {
        e.preventDefault()
        this.handleHistory(`employee=${this.props.contactsStore.employee}`, `&department=${this.props.contactsStore.department}`)
        this.props.contactsStore.getStuff()
    }
    ...
    clearTextField = () => {
        this.props.contactsStore.setEmploee('')
        this.handleHistory(``, `&department=${this.props.contactsStore.department}`)
        this.props.contactsStore.selectEmployee()
        this.props.contactsStore.getStuff()
    }
    ...
    render() {
        ...
        const {departmentsForSelect, staffForSelect, department, staff, loading, employee} = this.props.contactsStore
        ...
        return (
            ...
            <section className='phonebook section-wrapper'>
                ...
                <form className="row mb-4">
                    ...
                    <div className="col-1">
                        <button type='submit' onClick={this.submitQuery} className='btn-blue btn-blue_lighter'>НАЙТИ
                        </button>
                    </div>
                </form>
                        ...
                        }
                        {
                            ...
                            staff.map((el, i) =>
                                <div key={i} className="col-3 phonebook__col">
                                    <EmployeeCard
                                        thumb_urls={el.thumb_urls.avatar ? el.thumb_urls.avatar.thumb : ''}
                                        surname={el.surname}
                                        name={el.name}
