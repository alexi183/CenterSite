        ...
        return (
            <DocumentTitle title="Вестник образования">
                        ...
                        <div className="herald-page__content">
                            <div className="herald-page__content__about">
                                <div className="herald-page__content__flex">
                                    ...
                                    Журнал «Вестник образования» имеет давнюю и интересную историю.
                                    Он был создан в 1922 году Указом Наркома Луначарского и долгое
                                    время выходил под названием «Сборник приказов и инструкций
                                    Наркомата, Министерства просвещения РСФСР, Министерства
                                    образования России». В редакции «Вестника образования» и поныне
                                    хранится архив журнала с далёких 30-х и по настоящее время.
                                    Исключение составляют, пожалуй, только военные и первые
                                    послевоенные годы, когда журнал по понятным причинам не
                                    издавался. В 1991 году журнал получил свое нынешнее название. В
                                    настоящее время «Вестник образования» является единственным
                                    официальным изданием Министерства образования и науки Российской
                                    Федерации в сфере публикации нормативно-правовой документации.
                                    За материалы, опубликованные в других изданиях, Минобрнауки
                                    России ответственности не несёт.
                                </div>
                                <div
                ...
                – действующая должность Петрова А.Е.
                                ...
                                <div style={{ marginBottom: "9px" }}>
                                    <span style={{ fontWeight: "700" }}>Редактор:</span> Д.В.Куракин
                                </div>
                                <div style={{ marginBottom: "9px" }}>
                                    Тел.: 8 (495) 995-10-54, доб. 2181 Н. Минасян
                                </div>
                        ...
                        <div className="side-menu">
                            ...
                            <a href="http://www.vestnikedu.ru/ " className="side-menu__item">Архив выпусков</a>
                        </div>
                    </div>
                </section>
            </DocumentTitle>
